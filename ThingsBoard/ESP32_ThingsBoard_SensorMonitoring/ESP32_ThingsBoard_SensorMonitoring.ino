...
// WiFi access point
#define WIFI_AP_NAME       "YOUR WiFi SSID"// "WIFI_AP"
// WiFi password
#define WIFI_PASSWORD      "YOUR WiFi PASSWORD"// "WIFI_PASSWORD"

// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
#define TOKEN              "YOUR ACCESS TOKEN" // "TOKEN"
...
int send_delay = 2000;  //ThingsBoard'a veri gönderme süresi.
...
void loop() {
  ...
  // Check if it is a time to send HDC1080 temperature and humidity
